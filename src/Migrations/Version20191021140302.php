 ...
 */
final class Version20191021140302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD full_name VARCHAR(250) NOT NULL, CHANGE roles roles JSON NOT NULL');
    }
